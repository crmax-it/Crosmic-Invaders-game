...
def main():
    ...
    keyboard_btn = Button(Colors.BACKGROUND_BLACK, Colors.WHITE, "Play")
    ...
    while run:
        ...
        keyboard_btn.draw(
            (config.center_x - 100, config.center_y + 42), (195, 66))
        ...
        # ScoreBoard Page
        trophy_btn.draw((config.ending_x - 72, 55), True, True)

        # Settings Page
        settings_btn.draw((config.ending_x - 72, 165), True, True)

        # Ships Page
        ships_btn.draw((config.starting_x + 72, 53), True, True)
