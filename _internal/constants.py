...
class Image:
    ...
    TOOLBOX_IMAGE = Assets.image.scale(Path.GRAPHICS_PATH, 'volume.png', 1/2)

    TOOLS_IMAGE = Assets.image.scale(Path.GRAPHICS_PATH, 'audio.png', 1/4)
